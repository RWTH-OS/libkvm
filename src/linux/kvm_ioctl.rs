...
pub const KVM_CREATE_PIT: u64 = define_ioctl_op!(_IOC_NONE, 0x64, 0);
pub const KVM_CREATE_PIT2: u64 = define_ioctl_op!(_IOC_WRITE, 0x77, size_of::<kvm_pit_config>() as u32);
...
pub const KVM_TRANSLATE: u64 = define_ioctl_op!(_IOC_READ | _IOC_WRITE, 0x85, size_of::<kvm_translation>() as u32);
